...
describe("MultiplayerGamePlayerContainer", () => {
    ...
    it("should render", () => {
        const {baseElement} = render(
            <MultiplayerGamePlayerContainer started onGameOver={jest.fn} gameSettings={dummyMultiplayerSettings}
                                            code={"Test"} otherPlayers={[dummyPlayers[0]]} updateStats={jest.fn}/>
        )
