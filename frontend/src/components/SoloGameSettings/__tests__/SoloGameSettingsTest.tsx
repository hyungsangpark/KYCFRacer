...
describe("SoloGameSettings", () => {
  ...
  it("should render the solo game settings", () => {
    const {baseElement} = render(<SoloGameSettings onStartGame={onStartClick} onBackClick= {onBackClick} />);

    expect(baseElement).toBeInTheDocument();
  });

  it("should correctly render settings components", () => {
    const {getByText} = render(<SoloGameSettings onStartGame={onStartClick} onBackClick= {jest.fn}/>)
  ...
  it("should correctly render buttons", () => {
    const {getByText} = render(<SoloGameSettings onStartGame={onStartClick} onBackClick={onBackClick}/>);
