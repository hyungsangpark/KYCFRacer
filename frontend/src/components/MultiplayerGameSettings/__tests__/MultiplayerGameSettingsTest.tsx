...
describe("MultiplayerGameSettings", () => {
  ...
  it("should render the multiplayer game settings", () => {
    const {baseElement} = render(<MultiplayerGameSettings updateSettings={updateSettings} />);

    expect(baseElement).toBeInTheDocument();
  });

  it("should correctly render settings components", () => {
    const {getByText} = render(<MultiplayerGameSettings updateSettings={updateSettings}/>)
